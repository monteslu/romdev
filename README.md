...
- **Reverse-engineers and romhackers** — disassembly, control-flow graphs, a decompiler, live memory search, and write-breakpoints across all 17 systems, no $3,000 IDA license.
