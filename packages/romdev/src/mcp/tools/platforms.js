...
const PLATFORM_QUIRKS = {
  ...
  pce: {
    ...
    notes: [
      ...
      "Debugging: getCPUState (huc6280), inspectPalette, inspectSprites, getRenderingContext (VDC R5 screen-enable + scroll), readMemory regions pce_vdc_vram/pce_vdc_satb/pce_vdc_regs/pce_vce_palette/pce_cpu_regs.",
    ],
  ...
  msx: {
    ...
    notes: [
      ...
      "Debugging: getCPUState (z80), inspectPalette, inspectSprites (VRAM sprite-attr table), getRenderingContext (VDP R1 screen-enable + mode + VRAM table bases), readMemory regions msx_vram/msx_vdp_regs/msx_vdp_status/msx_palette/msx_cpu_regs.",
    ],
