...
; music_data: FamiTone2-format music data, generated by text2data from a
; FamiTracker .txt export. Bundled as a public-domain example track
; (Shiru's TestMusic3 from the famitone2d test suite — see LICENSE-FAMITONE).
; To swap in your own song: run text2data on your .ftm export and replace
; the bytes below (keep the `_music_data:` label + the RODATA segment).
.export _music_data
.segment "RODATA"
_music_data:
	.byte 2
