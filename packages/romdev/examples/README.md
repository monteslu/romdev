...
| atari2600 (gallery shooter) | `atari2600/templates/mini_invaders.asm` | dasm | Space-Invaders-shaped 2600 game using the RIGHT TIA objects (not playfield "barcode" bars): P0 double-width cannon, P1 + NUSIZ1=%011 = a row of 3 hardware-replicated invaders, M0 = shot. Aliens march + drop at edges; button fires. The honest 2600-idiomatic genre layout. `createProject({platform:"atari2600", template:"mini_invaders"})`. |
