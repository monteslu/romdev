...
const TEMPLATES = {
  ...
  // (text.c and persist.c are deliberately absent: one wants a generated font
  // asset we do not ship, the other a module flag we do not set).
  gametank: {
    shmup: {
      main: "templates/shmup.c",
      runtime: [
        { src: "lib/gt/gametank.h", dst: "gametank.h" },
        { src: "lib/gt/gametank.c", dst: "gametank.c" },
        { src: "lib/gt/input.h", dst: "input.h" },
        { src: "lib/gt/input.c", dst: "input.c" },
        { src: "lib/gt/init.c", dst: "init.c" },
        { src: "lib/gt/banking.h", dst: "banking.h" },
        { src: "lib/gt/banking.c", dst: "banking.c" },
        { src: "lib/gt/banking2.s", dst: "banking2.s" },
        { src: "lib/gt/wait.s", dst: "wait.s" },
        { src: "lib/gt/interrupt.s", dst: "interrupt.s" },
        { src: "lib/gt/gfx/gfx_sys.h", dst: "gfx_sys.h" },
        { src: "lib/gt/gfx/gfx_sys.c", dst: "gfx_sys.c" },
        { src: "lib/gt/gfx/draw_queue.h", dst: "draw_queue.h" },
        { src: "lib/gt/gfx/draw_queue.c", dst: "draw_queue.c" },
        { src: "lib/gt/gfx/draw_direct.h", dst: "draw_direct.h" },
        { src: "lib/gt/gfx/draw_direct.c", dst: "draw_direct.c" },
        { src: "lib/gt/gfx/draw_util.s", dst: "draw_util.s" },
        { src: "lib/gt/gfx/sprites.h", dst: "sprites.h" },
        { src: "lib/gt/gfx/sprites.c", dst: "sprites.c" },
        { src: "lib/gt/audio/audio_coprocessor.h", dst: "audio_coprocessor.h" },
        { src: "lib/gt/audio/audio_coprocessor.c", dst: "audio_coprocessor.c" },
        { src: "lib/gt/audio/audio_fw_blob.s", dst: "audio_fw_blob.s" },
        { src: "lib/gt/audio/acp_image.bin", dst: "acp_image.bin" },
        { src: "lib/gt/audio/instruments.h", dst: "instruments.h" },
        { src: "lib/gt/audio/instruments.c", dst: "instruments.c" },
        { src: "lib/gt/audio/music.h", dst: "music.h" },
        { src: "lib/gt/audio/music.c", dst: "music.c" },
        { src: "lib/gt/audio/note_numbers.h", dst: "note_numbers.h" },
        { src: "lib/gt/audio/sine_256_-63_63.bin", dst: "sine_256_-63_63.bin" },
        { src: "lib/gt/feature/random/random.h", dst: "random.h" },
        { src: "lib/gt/feature/random/random.c", dst: "random.c" },
        { src: "lib/gt/gen/modules_enabled.h", dst: "modules_enabled.h" },
        { src: "lib/gt/gen/modules_enabled.inc", dst: "modules_enabled.inc" },
        { src: "lib/gt/gen/bank_nums.h", dst: "bank_nums.h" },
        { src: "lib/gt/gen/assets/assets_index.h", dst: "assets_index.h" },
      ...
      extraSources: [
        ...
        { src: "templates/gt_sprites.h", dst: "gt_sprites.h" },
        { src: "templates/gt_hud.h", dst: "gt_hud.h" },
        { src: "templates/gt_sound.h", dst: "gt_sound.h" },
      ],
