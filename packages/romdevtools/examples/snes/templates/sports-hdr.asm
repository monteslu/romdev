;==LoRom== sports hdr.asm — PROJECT OVERRIDE of PVSnesLib's stock header
;
...
; open bus at $70:0000 and the best win streak never survives a power cycle.
;
...
.SNESHEADER
  ...
  NAME "NET SURGE            "  ; Program Title - 21 bytes, space-padded.
