...
bool retro_load_game(const struct retro_game_info *game)
{
   ...
   useEmuThread              = false;  // romdev: GL on the app thread (where romdev_proxied_run runs)
#else
   ...
   // Disable HLE function replacements under the pure interpreter: replacements install "emuhack"
   // opcodes meant for the JIT, and on a bad/missing replacement index Int_Emuhack re-interprets
