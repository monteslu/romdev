...
# ── romdev shared debug lib (0.80.0) ─ stage into core/ (on the -I$(CORE_DIR) path)
RDBG_SRC="$PROJECT_DIR/scripts/romdev-debug"
cp "$RDBG_SRC/romdev_debug.h" "$RDBG_SRC/romdev_debug.c" "$DIR/core/"
ROMDEV_INC="-I$DIR/core"
...
emcc -c -O2 "$DIR/core/romdev_debug.c" -o "$DIR/core/romdev_debug.o"
...
emar rcs "$CORE_LIB" "$DIR/core/romdev_debug.o"
