#!/usr/bin/env bash
# Build the sh-elf cross-toolchain (binutils + gcc + newlib + libgcc)
# natively, into build/sh-toolchain/install/. STAGE 1 of the Dreamcast C tier.
#
...
#
# Target: sh-elf, big-endian default (Dreamcast SH-4). SH-4 is little-endian, m4-single FP (DC ABI)
