...
- **A block could be executed twice.** The dispatch-miss handler for "block is
  ...
  local as PR, and jumped to garbage. That was the Soul Calibur boot hang.
...
(a static picture means "waiting on input", not "hung" — Crazy Taxi parks on its
...
**v0.98.0 feedback batch** (Jay McGavren's Zanac annotation session, shared
